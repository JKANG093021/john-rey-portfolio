...
export async function POST(request: Request) {
  try {
    ...
    const workType = clean(body.workType, 80);
    ...
    if (!name || !validEmail(email) || !workType || message.length < 15) {
      return NextResponse.json(
        { message: "Please complete your name, valid email, support type, and a short project message." },
        { status: 400 },
      );
    }
    ...
    await transporter.sendMail({
      ...
      text: `Hi ${name},\n\nThanks for reaching out through my portfolio. I received your inquiry about ${workType}.\n\nI'll review the details you sent and get back to you as soon as I can. If there is anything important I should know—such as a deadline, live website link, or specific issue—you can reply directly to this email.\n\nBest,\nJohn Rey Baliguat\nTechnical Virtual Assistant | Web Support & Automation\n${gmailUser}`,
      html: `
        <div style="font-family:Arial,sans-serif;max-width:620px;margin:auto;color:#172033;line-height:1.7">
          ...
          <p>I&apos;ll review the details you sent and get back to you as soon as I can. If there is anything important I should know—such as a deadline, live website link, or specific issue—you can reply directly to this email.</p>
          <p style="margin-top:28px">Best,<br /><strong>John Rey Baliguat</strong><br />Technical Virtual Assistant | Web Support &amp; Automation<br />${escapeHtml(gmailUser)}</p>
        </div>
      `,
    });
